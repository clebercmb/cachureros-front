...
const UserProfile = (props) => {
  ...
  useEffect(() => {
    console.log(
      "UserProfile.userEffect (1):Behavior before the component is added to the DOM"
    );
    console.log(
      "UserProfile.userEffect (1):props.match.params.id",
  ...
  useEffect(() => {
    console.log(
      "UserProfile.userEffect (2):Behavior before the component is added to the DOM"
    );
    console.log(
      "UserProfile.userEffect (2):props.match.params.id",
      props.match.params.id
    );
  ...
  useEffect(() => {
    console.log(
      "UserProfile.userEffect (3):Behavior before the component is added to the DOM"
    );
  ...
  const regionListOptions = store.regionList.map((region, i) => {
    return (
      <option key={region.id} id={region.id} value={region.id}>
        {region.name}
      </option>
    );
  });
  ...
  async function handleSubmit(e) {
    ...
    formData.append(
      "hasUserStorePhotoUrl",
      state.userProfile.userStorePhoto !== ""
    );
    ...
    await fetch(url, {
      ...
      .then((data) => {
        ...
        if (newState.responseMessage.user) {
          ...
          console.log(
            ">>>>>>UserProfile.store.login= (Before API call):",
            store.login
          );
          ...
          console.log(
            ">>>>>>UserProfile.store.login= (After API call):",
            store.login
          );
        }
        ...
        <div className="userProfile-container">
          <div className="userProfile-item-left">
            <div className="userProfile-item-left-item-01">
              <img
                ...
                src={state.userProfile.userPhotoImage}
              />
          ...
          <div className="userProfile-item-right">
              ...
              <div className="userProfile-item-right-item2-perfil">
                ...
                <div className="userProfile-item-right-item2-perfil-photo">
                  ...
                  <div className="userProfile-item-right-item2-perfil-photo-item2">
                    <input
                      ...
                      ref={(input) => (state.fileInputUserPhoto = input)}
                      onChange={(e) =>
                        handleFile(e, "userPhoto", "userPhotoImage")
                      }
                    />

                    <button
                      className="button-blue"
                      onClick={() => state.fileInputUserPhoto.click()}
                    >
                      cambiar foto
                    </button>
                  </div>
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                  ...
                  <div className="form-group userProfile-item-right-item2-perfil-bio">
                    <label htmlFor="bio" className="userProfile-label">
                      bio
                    </label>
                    <textarea
                      id="bio"
                  ...
                  <div className="form-group userProfile-item-right-item2-perfil-item">
                    <label htmlFor="url" className="userProfile-label">
                      url
                    </label>
                  ...
                  <div className="form-group userProfile-item-right-item2-perfil-item">
                    <label htmlFor="region" className="userProfile-label">
                      Region
                    </label>
                    <select
                      name="region"
                      id="region"
                      value={store.userStore.region.id}
                      className="form-control userProfile-input"
            ...
            <div className="userProfile-item-right-item2">
              <div className="userProfile-item-left-item-01">
                <img
                  className="photo-tendita"
                  src={state.userProfile.userStorePhotoImage}
                />

                <button
                  className="button-blue userProfile-item-left-item-01-button"
                  onClick={() => state.fileInputUserStorePhoto.click()}
                >
                  foto de capa
                </button>
                ...
                <input
                  ...
                  id="file-browser-input"
                  name="file-browser-input"
                  ref={(input) => (state.fileInputUserStorePhoto = input)}
                  onChange={(e) =>
                    handleFile(e, "userStorePhoto", "userStorePhotoImage")
                  }
                />
              </div>
            </div>
