...
const AddProductView = (props) => {
  ...
  function handleFilePhotoProduct(file, image, index) {
    ...
    console.log(
      "AddProductView.handleFilePhotoProduct.state.photos=",
      state.photos
    );
  }
  ...
  function handleChange(e, field) {
    ...
    product[field] = value;
    if (e.target.type === "checkbox") product[field] = e.target.checked;
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 1-Behavior before the component is added to the DOM"
    );
    console.log(
      "AddProductView.useEffect 1-props.match.params.id",
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 2-Behavior before the component is added to the DOM"
    );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect-3-Behavior before the component is added to the DOM"
    );
    ...
    if (store.product && store.product.id !== "") {
      let newState = state.product;
      console.log(
        "AddProductView.useEffect-3-store.product.photos.length=",
        store.product.photos.length
      );
      for (let i = 0; i < store.product.photos.length; i++) {
        console.log(
          "AddProductView.useEffect-3-store.product.photos=",
          i,
          store.product.photos[i]
        );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 2-Behavior before the component is added to the DOM - departmentList"
    );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 3-Behavior before the component is added to the DOM - categoryList"
    );
    console.log(
      "AddProductView.useEffect 3-props.match.params.id",
      props.match.params.id
    );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 4-Behavior before the component is added to the DOM - sizeList"
    );
    console.log(
      "AddProductView.useEffect 4-props.match.params.id",
      props.match.params.id
    );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 5-Behavior before the component is added to the DOM - productStateList"
    );
    console.log(
      "AddProductView.useEffect 5-props.match.params.id",
      props.match.params.id
    );
  ...
  useEffect(() => {
    console.log(
      "AddProductView.useEffect 6-Behavior before the component is added to the DOM - categoryList"
    );
    console.log(
      "AddProductView.useEffect 6-props.match.params.id",
      props.match.params.id
    );
  ...
  const productStateListOptions = state.productStateList.map(
    (productState, i) => {
      return (
  ...
  const weightUnitListOptions = state.weightUnitList.map((weightUnit, i) => {
    return (
      <option key={weightUnit.id} value={weightUnit.id}>
        {weightUnit.name}
      </option>
    );
  });
  ...
  let handleSubmit = (e) => {
    ...
    console.log(
      "****>AddProductView.handleSubmit.state.product=",
      state.product
    );
    ...
    formData.append("hasUpLoadPhotos", [
      state.product.photos[0] != "",
      state.product.photos[1] != "",
      state.product.photos[2] != "",
      state.product.photos[3] != "",
      state.product.photos[4] != "",
    ]);
    ...
    console.log(
      "AddProductView.handleSubmit.store.login.data.user.userStore",
      store.login.data.user.userStore
    );
    ...
    let methodCall = "POST";
    console.log(
      "AddProductView.handleSubmit.state.product.id=",
      store.product.id,
  ...
  console.log(
    ">>>>AddProductView.process.env.REACT_APP_BACK_IMAGES=",
    process.env.REACT_APP_BACK_IMAGES
  );
  ...
  return (
    <>
      {store.product && (
        <form
          className="form-group add-product-view-container"
          onSubmit={(e) => handleSubmit(e)}
        >
          <div className="add-product-view-a">
            <div className="add-product-view-a-01">
              <DraggableUploader
                src={state.product.images[0].src}
                small={state.product.images[0].small}
                handleFile={handleFilePhotoProduct}
                index={0}
                type="L"
              />
            </div>
            <div className="add-product-view-a-02">
              <div className="add-product-view-a-02-01">
                <DraggableUploader
                  src={state.product.images[1].src}
                  small={state.product.images[1].small}
                  handleFile={handleFilePhotoProduct}
                  index={1}
                  type="S"
                />
              ...
              <div className="add-product-view-a-02-01">
                <DraggableUploader
                  src={state.product.images[2].src}
                  small={state.product.images[2].small}
                  handleFile={handleFilePhotoProduct}
                  index={2}
                  type="S"
                />
            ...
            <div className="add-product-view-a-02">
              <div className="add-product-view-a-02-01">
                <DraggableUploader
                  src={state.product.images[3].src}
                  small={state.product.images[3].small}
                  handleFile={handleFilePhotoProduct}
                  index={3}
                  type="S"
                />
              ...
              <div className="add-product-view-a-02-01">
                <DraggableUploader
                  src={state.product.images[4].src}
                  small={state.product.images[4].small}
                  handleFile={handleFilePhotoProduct}
                  index={4}
                  type=""
                />
          ...
          <div className="add-product-view-b">
            <p className="add-product-view-b-01">
              ¡Vender es bueno y a todos les gusta!
            </p>
            <p className="add-product-view-b-02">
              Luce genial en tus fotos y descripción del producto
            </p>

            <label htmlFor="name" className="add-product-view-b-03">
              Nombre
            </label>
            <input
              type="text"
            ...
            <div className="add-product-view-b-04">
              <div>
                ...
                <input
                  type="text"
                  className="add-product-view-b-04-01 marg"
            ...
            <div className="add-product-view-b-05">
              <div className="product-feed-filters-content-body-wrapper">
                <label name="hasBrand" className="container-checkbox">
                  Sin Marca
                  <input
                    value={store.product.hasBrand}
                    id="hasBrand"
                    name="hasBrand"
                    type="checkbox"
                    onChange={(e) => handleChange(e, "hasBrand")}
                  />
            ...
            <div className="add-product-view-b-06"></div>
            ...
            <div className="add-product-view-b-04">
              ...
              <div>
                <p>
                  <label htmlFor="productState">Estado del producto</label>
                </p>
                <select
                  type="text"
                  className="add-product-view-b-04-01  marg"
            ...
            <div className="add-product-view-b-04">
              <div>
                <p>
                  <label htmlFor="weightUnit">Unid Peso producto</label>
                </p>
                <select
                  type="text"
                  className="add-product-view-b-04-01  marg"
            ...
            <div className="add-product-view-b-04">
              <div>
                <p>
                  <label htmlFor="originalPrice">Precio Descuento</label>
                </p>
                <input
                  type="text"
                  className="add-product-view-b-04-01  marg"
            ...
            <div className="add-product-view-b-04">
              <div>
                <p>
                  <label>{state.respondMessage}</label>
                </p>
              </div>
            </div>
