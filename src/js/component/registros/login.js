  ...
  render() {
    return (
      <div className="containerLogin">
        ...
        <form className="box">
          <input type="text" id="fname" name="fname" placeholder="Introduce tu email"  className="boxregistro"/>
          <input type="text" id="fname" name="fname" placeholder="Contraseña"  className="boxregistro"/>
          <input type="button" id="fname" name="fname" value="Soy Cachurero"  className="botonregistro"/>
