        ...
        <div key={props.prod.id} className="col-md-3">
            ...
            <div className="card-body">
                ...
                <div className='product-card-buttons'>
                    {
                        !!props.addProduct && (
                            <button className='button-blue-product-card' onClick={e=>handleProduct(props.prod)}>Agregar</button>
                        )                    
                    }
                    {
                        !!props.editProduct && (
                    ...
                    {
                        !!props.removeProduct && (
                            <button className='button-blue-product-card' onClick={e=>props.removeProduct(props.prod)}>Remover</button>
                        )                    
                    }
